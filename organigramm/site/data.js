...
window.ORG_DATA = {
  ...
  nodes: [
    ...
    { id: "BBS", label: "Beratungsbüro Süd",    role: "Beratungsbüro", description: "Adresse und Leitung: lokal zu prüfen.",
      verify: "snippet", sources: ["S5"] },
    { id: "BBW", label: "Beratungsbüro West<br/>Gneisenaustr. 2a", role: "Beratungsbüro im Mehringhof, Kreuzberg",
      description: "Gneisenaustr. 2a, 10961 Berlin-Kreuzberg (Mehringhof). U6/U7.", verify: "snippet", sources: ["S5"] },

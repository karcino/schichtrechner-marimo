...
export default function PrivateTabs({ dataset }: { dataset: PrivateDataset }) {
  ...
  return (
    <div className="min-h-screen bg-paper dark:bg-ink">
      <nav className="border-b border-ink-soft/10 bg-white dark:bg-ink-soft px-4 py-2 flex items-center gap-2">
      ...
      {tab === "buero" && <PrivateBueroOrgView persons={dataset.persons} />}
